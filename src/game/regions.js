...
export const REGIONS = [
  ...
  { key: 'river', label: 'the river & the Zana', cx: 250, cy: 1070, rx: 300, ry: 300, terrain: 'river', anchors: ['lumi', 'zana1', 'bolla1', 'ura', 'uraFshaj', 'riddle1', 'zanaProva', 'zanaFole', 'flocka1', 'rrethi', 'shpellaHyrje'] },
