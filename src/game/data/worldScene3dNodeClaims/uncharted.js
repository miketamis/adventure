...
{"id":"description:gjizarAnija:1","nodeId":"gjizarAnija","lineIndex":1,"placeId":null,"text":"Në anije, Bukura të pyet: si e ke marrë zogun? thuaj të drejtën.","conditions":{"all":[],"negate":false,"none":[],"observationId":null},"objects":[{"key":"gjizar-beauty-ship","asset":"ship","label":"Beauty’s ship","zone":"front","attributes":{},"count":1,"persistence":"scene"},{"key":"actor:gjizar-bukura","asset":"human","label":"Bukura","zone":"near","attributes":{"gender":"woman"},"count":1,"persistence":"scene"}],"states":[],"relations":[],"disposition":"mixed","rationale":"Aboard her ship, Bukura asks how the player obtained the bird; neither an answer nor a wedding precedes the tell-truth choice."},
{"id":"description:gjizarFund:0","nodeId":"gjizarFund","lineIndex":0,"placeId":null,"text":"ti i tregon Bukurës të drejtën për zogun.","conditions":{"all":["arrival:action:gjizar-tell-truth"],"negate":false,"none":[],"observationId":null},"objects":[{"key":"actor:gjizar-bukura","asset":"human","label":"Bukura","zone":"near","attributes":{"gender":"woman"},"count":1,"persistence":"scene"}],"states":[],"relations":[],"disposition":"mixed","rationale":"Only after the tell-truth action does the player answer the present Bukura; no king, rope or well is established here."},
{"id":"description:gjizarFund:1","nodeId":"gjizarFund","lineIndex":1,"placeId":null,"text":"ajo thotë: unë do të martohem me ty. pastaj dasma vjen.","conditions":{"all":["arrival:action:gjizar-tell-truth"],"negate":false,"none":[],"observationId":null},"objects":[{"key":"actor:gjizar-bukura","asset":"human","label":"Bukura","zone":"near","attributes":{"gender":"woman"},"count":1,"persistence":"scene"}],"states":[],"relations":[],"disposition":"mixed","rationale":"Bukura promises marriage and the wedding follows; unspecified guests, feast objects and ceremony locations are not invented."},
