...
export default {
  ...
  references: [
    { role: 'translation', citation: 'Robert Elsie, “The Ballad of Constantine and Dhoqina” — surviving Albanian Literature author site', url: 'http://www.albanianliterature.net/oralverse/verse_04.html', note: 'Translation of the selected Chameria witness from Balada shqiptare; this legacy author site has no working HTTPS endpoint.' },
    { role: 'catalog', citation: 'Vladimir Zoto (ed.), Balada shqiptare (Dasara, 2006) — Epoka University Library record', url: 'https://lib.epoka.edu.al/bib/3369', note: 'Institutional catalogue record for the exact Albanian collection and edition behind the selected Chameria witness.' },
    { role: 'scholarship', citation: 'Katica Kulavkova, “The Dead Brother’s Ballad as a Balkan Shared Place of Memory” (European Scientific Journal, 2021)', url: 'https://doi.org/10.19044/esj.2021.v17n39p1' },
    { role: 'variant', citation: 'Pralla popullore shqiptare (1954) — complete online transcription', url: 'https://doczz.net/doc/2729503/pralla-popullore-shqiptare', note: 'Contains «Plaka me nëntë djelm», the Albanian prose variant used for source-language comparison; not the selected Chameria ballad.' },
  ],
  source:
  ...
  discrepancies: [
    ...
    'ONE DEATH OR TWO (explicit sourced variants): the recovered 1954 Albanian prose text kills only the mother and leaves Doruntina alive outside the door. Elsie\'s Chameria ballad, the primary telling selected for this record and the playable ending, kills both women. The lore card and ending now label those outcomes by source instead of presenting the two-death close as universal.',
    ...
    'THE HERO\'S OTHER NAMES / SEPARATE WITNESSES: Elsie\'s headnote groups Halil Garria, Ali and Hysen i vogël as regional names of the same broad dead-brother folk type. The recovered Halil Garria ballad, however, is not treated as this tale\'s Kostandini performance: it begins with a besa sold for fifty purses, uses earth-smell, a silent flute and speaking birds on the return road, and kills mother and sister together at Halil\'s grave. It therefore has its own tale record and NPC (`halil-garria` / `halilGarria`). The names are comparative folklore context, not permission to merge two incompatible event histories into one staged person.',
  ],
