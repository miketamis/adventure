...
export default {
  ...
  play: {
    ...
    divergences: [
      ...
      { beat: 'kenga', note: 'Hahn\'s 1854 Albanesische Studien, p.165, preserves the flower song in Greek-alphabet Albanian. The local record keeps its eight verse lines as five sentence units, with the transliteration uncertainties disclosed. The playable flower ending narrates the women\'s singing and the flower\'s response rather than using those words as a verbatim Q() quotation.' },
    ],
  },
  beats: [
    {
