...
export default {
  ...
  references: [
    { role: 'source-text', citation: 'Hipi Zhdripi (collector), «Ymer Agë Ulqini» (Krajë, 2006) — Albanian Wikibooks transcription', url: 'https://sq.wikibooks.org/wiki/Ymer_Ag%C3%AB_Ulqini', note: 'Selected sung witness followed by this record.' },
    { role: 'variant', citation: 'Robert Elsie, “Aga Ymeri of Ulqin” (translation of Mitrush Kuteli’s prose retelling)', url: 'http://www.albanianliterature.net/legends/legend_03.html', note: 'Related nine-years-and-nine-days prose variant; not the selected sung text.' },
    { role: 'context', citation: '“Little Constantine” — returning-husband ballad overview', url: 'https://en.wikipedia.org/wiki/Little_Constantine', note: 'Comparative tale-family context, not a source for the Albanian wording.' },
  ],
  source:
  ...
  discrepancies: [
    'THE DEADLINE (explicit sourced variants, ¶3, ¶5, ¶9-10): this record\'s sung ballad negotiates up to a three-year vow. The shared playable Aga Ymer arc follows Kuteli/Elsie\'s prose variant at nine years and nine days, and the core NPC now says so explicitly. The unsupported former seven-year gloss has been removed.',
  ...
  places: [
    { id: 'home', emoji: '🏠', name: 'the kulla at Ulqin', note: 'Aga Ymer\'s tower-house, where the wedding, the countdown, and the homecoming all happen',
      anchor: { status: 'existing', node: 'plaka', mirror: 'Aga Ymer\'s own kulla at Ulcinj, the Adriatic town just across the border from Albania',
        ...
        conflicts: ['NOT a second Aga Ymer at another castle: the former duplicate registry entry was removed, and both selected tellings now deliberately share the canonical hero at agaYmer1 while keeping their differing chronologies explicit'] } },
  ...
  beats: [
    ...
    },
    {
      ...
      lines: [
        ...
        ['4.4', 'In the third, he was taken captive and thrown into a dark cell, sentenced to three years.', "Kur ka ra në luftë të tretë, rabazan e kanë marrë. Rap e xun, n'burk e çuen, për tri vjet ata e shkruen; e kanë shti n'burk të zi, tri vjet burgun ja kanë pre.", '“Rap e xun” is printed thus; its contextual sense is “seized.”'],
      ],
      cast: {
    ...
    },
    {
      ...
      lines: [
        ['5.1', 'Aga Ymeri counted the days, counted the nights, until three years had run their course.', "Aga Imeri njehen dit', njehen dit' e njehen net', der .iu mllshen tri vjet.", 'The final phrase is printed thus; its contextual sense is “until three years had run their course.”'],
    ...
    },
    {
      ...
      lines: [
        ['7.1', 'But the moment that companion had gone, Aga Ymeri could not eat, could not drink, and would not touch his lute again.', "Masi shkoi ai shoqi j ti, Ag-ja s'pa ha as s'pa pi, as dyzenit ma s'pa i bje.", '“shoqi j ti” is printed thus; its contextual sense is “his companion.”'],
    ...
    },
    {
      ...
      lines: [
        ['8.1', 'One morning the king\'s daughter, leaning from her window, asked Aga Ymer why his lute had gone quiet — what had soured him?', "Kur nji ditë, në natje htret, bija e mretit del n'penxhere, Aga Imerin p'i peveten: «Hajr allah e Aga Imer, po dyzenit pse s'pa i bje? Ç'ke Imer qi je idhnue?»", '“natje htret” is printed thus; its sense remains uncertain.'],
        ...
        ['8.4', 'He begged her to win him leave from her father, to be sent home under three pledges instead of ransom.', "«Izën mretit me m'kshu, me ju lut njér per mue! Tre darzan me m'i çue!»", '“m’kshu” is printed thus; its contextual sense is “grant me leave.”'],
      ],
      cast: {
    ...
    },
    {
      ...
      lines: [
        ['10.1', 'He carried the same plea to the king himself, weeping openly as he told the dream again.', "Ju çue ag-ja shkoi te mretit. Për jastek pa rri pështetë, pa i shin lot' me faculetë. «Çka ke, ag-o, qi pa kjan?» Ç'ka qitë ag-ja e i ka thanë: «natën, nat në mjesnatë unë e pash nji andërr t'zorshme — sarajet m'ishin rranue, nanë e babë m'ishin qerrue, vasha donte m'u martue, motra m'jitte pa u martue. Aman mret me m'leshue!»", '“shin” and “m’jitte” are printed thus; the latter contextually denotes his sister.'],
    ...
    },
    {
      ...
      lines: [
        ...
        ['12.3', 'He told them Aga Ymeri had died three days before — that he himself had washed the body, mourned him, and buried him with his own hands.', "«Unë jam vesht për t'zi, gjith të zitë për tê e kam — Aga Imeri na ka dek, tash tri dit në dhé ka hi; vetë e lava, vetë e kjava, të shtatat me dorë ja dava.»", 'The opening phrase is OCR-obscure and retained without conjectural repair.'],
    ...
    },
    {
      ...
      lines: [
        ...
        ['13.2', 'He repeated to her that Aga Ymeri had died three days before, and that his own hands had buried him.', "«Unë jam vesht për t'zjft e ti, gjith te zitë për tê e kam — Aga Imeri na ka dek, tash tri dit në dhé ka hi; vetë e lava, vetë e kjava, të shtatat me dorë ja dava.»", 'The opening phrase is OCR-obscure and retained without conjectural repair.'],
