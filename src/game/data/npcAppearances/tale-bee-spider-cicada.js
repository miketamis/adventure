...
export const SPIDER_SISTER_APPEARANCE = portrait({
  ...
  details: ['age', 'clothing', 'location'], practicalWordIds: ['motra', 'madh', 'rroba', 'qilim'],
  placement: { kind: 'replace', lineIndex: 2 },
  portraitLines: [{ line: R('The eldest sister, in dark clothes, stands beside a rug.', w('motra'), w('e_art'), w('madh'), p(','), w('me'), w('rroba'), w('te_link'), w('erret'), p(','), w('rri'), w('prane'), w('nje'), w('qilim'), p('.')) }],
})
...
export const CICADA_SISTER_APPEARANCE = portrait({
  ...
  portraitLines: [{ line: R('The second sister wears red clothes and can sing with a loud voice.', w('motra'), w('e_art'), w('dy', 'dytë'), w('vesh'), w('rroba'), w('te_link'), w('kuq', 'kuqe'), w('dhe'), w('di'), w('te_subj'), w('kendo', 'këndojë'), w('me'), w('nje'), w('ze'), w('te_link'), w('madh'), p('.')) }],
})

export const BEE_SISTER_APPEARANCE = portrait({
  npcId: 'motraBleta', nodeId: 'bleta1',
  details: ['age', 'clothing', 'location'], practicalWordIds: ['motra', 'vogel', 'rroba', 'dritare'],
  placement: { kind: 'replace', lineIndex: 4 },
  portraitLines: [{ line: R('The youngest sister, in white clothes, stands beside the window.', w('motra'), w('e_art'), w('vogel'), p(','), w('me'), w('rroba'), w('te_link'), w('bardhe'), p(','), w('rri'), w('prane'), w('dritare', 'dritares'), p('.')) }],
})
