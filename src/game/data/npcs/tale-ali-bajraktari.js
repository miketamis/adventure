...
export default {
  ...
  nenaAliut: {
    ...
    backstory:
      'Raised Ali alone on nothing, begging bread at other people\'s doors and dressing him in rags off the bushes. Swears him the besa he demands before he\'ll ride out — the door opened for no one but her son — and dies sometime during the three years he is held prisoner. The bride\'s own last letter never mentions it; Ali reveals the death himself when the king presses him over his scream in the dungeon, and the song never explains how or when he learned it. NOT nenaMujit (Mujo and Halili\'s own mother, who greets the disguised Ali warmly at Jutbina later in the same song) — two different aged mothers, one dead by the tale\'s second half, one very much alive.',
