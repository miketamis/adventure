...
export default {
  ...
  rusha: {
    ...
    backstory:
      'Kept in her father the Krajl\'s tower across the frontier, she will not open her door by night to any voice that might be Gjeto Basho Mujo or young Halil Aga — only when Zuku raises his hand to her window and she knows his coat-sleeve and the ring he once gave her does she let him in. He refuses her coffee until she swears before God to do as he says; after she gives her word, he drinks and stays a day and a night. She later dresses in her finest, fills her pockets with ducats, and rides home behind him to Jutbina — and is very nearly lost to Mujo\'s counter-claim before a cadi\'s horse-race settles it in Zuku\'s favor. The playable tower episode stops at her oath, which is a promise of obedience; drinking, the stay, the ride and the rival claim remain later source events.',
    folklore: ['zuku-bajraktar'],
