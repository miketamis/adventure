...
export default {
  ...
  krajliOsmanit: {
    ...
    backstory:
      'The Slav king across the frontier whose palace, kulla and forest Osmani\'s raiders burned down — he chains the whole band for nine years, adds six more when the boast doesn\'t shame them into silence, and when word comes that one prisoner has died he tests the body himself: nine serpents, two bonfires, twenty nails, then thirty dancing maidens, refusing to believe even his own daughter until the very last shackle is struck away — and pays for the doubt with an eye, an arm, and his palace. NOT Krajle Kapidani, who holds Muji alone in kreshnikRrembimiBurg, and NOT Rusha\'s father at the game\'s own rusha1 tower — "Krajl" names the standing office of the frontier\'s Slavic royal enemy across many songs, the way "kulshedra" names a kind and not one beast; each song\'s Krajl is his own man.',
    folklore: ['arnaut-osmani', 'kreshnik-epic'],
