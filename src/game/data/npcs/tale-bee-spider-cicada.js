...
export default {
  ...
  motraBleta: {
    ...
    backstory: 'The one who came when her mother called: she tended the sickbed, baked the little cake that comforted the old woman, and received the blessing — "you shall be the light of the ancestors and the food of the living." So she is the one creature whose work feeds both worlds: wax to the graveyard\'s forty-day candles, honey to the table of the living. Folk speech still gives her a person\'s death — a bee «vdes», never «ngordh» — and no one blasphemes in a house that keeps her hive.',
    folklore: ['bee-spider-cicada'],
    location: { status: 'placed', node: 'bleta1' },
