...
export const DICT = {
  ...
  ka:        { al: 'ka',        en: 'has', enAll: 'has / have / had / has not / there is' },
  ...
  meso:      { al: 'mëso',      en: 'teaches', enAll: 'teaches / teach / learn / you learn' }, // mësoj = both teach and learn
  ...
  fal:       { al: 'fal',       en: 'forgive', enAll: 'forgive / pardons' },  // falja e gjakut — forgiving the blood-feud; also = pardon/spare
...
export const STORY = {
  ...
  tregtari2: {
    ...
    text: [
      ...
      L(w('une'), w('shes'), w('edhe'), wf('rrobe', 'rroba', 'clothes'), w('per'), wf('vesh', 'të veshur', 'to wear'), p(':'), w('nje'), w('plis'), w('i_art'), w('bardhe'), p(','), w('nje'), w('xhublete'), p('.')),
