...
export const FIRST_MINUTES_PHRASES = Object.freeze([
  ...
  { al: 'po vij me ty.', maxDepth: 3, interactive: true },
  { al: 'takohemi më vonë.', maxDepth: 3, interactive: true },
...
export const EVERYDAY_CAN_DO_GROUPS = Object.freeze([
  ...
  { id: 'coordinate', label: 'locate people and make plans', minimum: 8, drillIds: ['where-going', 'setting-off-coming', 'meet-later', 'meet-tomorrow-question', 'accept-tomorrow-square', 'where-are-you', 'when-finish', 'all-right-later', 'who-will-come', 'going-guest-room', 'when-guests-come', 'at-noon'] },
