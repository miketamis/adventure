...
export const QUOTES = {
  ...
  'pralla-maro-lajmi': {
    label: 'Maro Përhitura — Pralla popullore shqiptare (1954)',
    game: "ti s' je për atje",
    gameTranslation: 'That is no place for you.',
    ...
    evidence: [
      {
        ...
        file: 'docs/references/pralla-1954-maro-perhitura.sq.txt',
        match: "u s' janv\npër atje",
        note: 'The scan\'s OCR reads janë as "janv". The game inflects Maro\'s first-person deflection into the stepmother\'s second-person dismissal so the embodied player is not made to speak without choosing to.',
      },
    ],
  },
  ...
  'pralla-maro-fundi': {
    label: 'Maro Përhitura — Pralla popullore shqiptare (1954)',
    game: 'tani ti je gruaja ime',
    gameTranslation: 'Now you are my wife.',
