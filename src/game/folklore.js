...
export const EXTRA_SOURCES = {
  'zojz': [{ label: 'Albanian paganism — Sky/Zojz (Wikipedia)', url: 'https://en.wikipedia.org/wiki/Albanian_paganism' }, { label: 'Elsie, Dictionary of Albanian Religion, Mythology and Folk Culture (2001)', url: 'https://archive.org/details/dictionaryofalba0000elsi' }],
  'dielli': [{ label: 'Albanian paganism — Dielli (Wikipedia)', url: 'https://en.wikipedia.org/wiki/Albanian_paganism' }],
  'hena': [{ label: 'Elsie, Dictionary of Albanian Religion & Mythology', url: 'https://archive.org/details/dictionaryofalba0000elsi' }],
  'prende': [{ label: 'Elsie, Dictionary (s.v. Prende/Premte)', url: 'https://archive.org/details/dictionaryofalba0000elsi' }],
  'i-verbti': [{ label: 'Elsie, Dictionary (s.v. Verbt, i)', url: 'https://archive.org/details/dictionaryofalba0000elsi' }],
  'shurdhi': [{ label: 'Elsie, Dictionary (s.v. Shurdhi)', url: 'https://archive.org/details/dictionaryofalba0000elsi' }],
  'nena-e-diellit': [{ label: 'Tirta, Mitologjia ndër shqiptarë (2004)', url: 'https://en.wikipedia.org/wiki/Albanian_paganism' }],
  'enji': [{ label: 'Albanian paganism — Enji/Zjarri fire cult (Wikipedia)', url: 'https://en.wikipedia.org/wiki/Albanian_paganism' }],
  'perendi': [{ label: 'Albanian paganism — Perëndi (Wikipedia)', url: 'https://en.wikipedia.org/wiki/Albanian_paganism' }],
  'nena-e-vatres': [{ label: 'Elsie, Dictionary (hearth/fire)', url: 'https://archive.org/details/dictionaryofalba0000elsi' }],
  'bukura-e-dheut': [{ label: 'Elsie, Albanian Folktales and Legends', url: 'https://www.albanianliterature.net/authors/folklore/index.html' }],
  ...
  'ora': [{ label: 'Doja, \'Mythology and Destiny\' (Anthropos 2005)', url: 'https://www.jstor.org/stable/40466705' }],
  'shtojzovalle': [{ label: 'Elsie, Dictionary (s.v. Shtojzovalle)', url: 'https://archive.org/details/dictionaryofalba0000elsi' }],
  'flocka': [{ label: 'Elsie, Dictionary of Albanian Religion & Mythology', url: 'https://archive.org/details/dictionaryofalba0000elsi' }],
  'peri': [{ label: 'Elsie, Dictionary (s.v. Peri)', url: 'https://archive.org/details/dictionaryofalba0000elsi' }],
  'fatia-mira': [{ label: 'Elsie, Dictionary (s.v. Fati, Miren)', url: 'https://archive.org/details/dictionaryofalba0000elsi' }],
  'zana-e-malit': [{ label: 'Doja, \'Mythology and Destiny\' (Anthropos 2005)', url: 'https://www.jstor.org/stable/40466705' }],
  'vitore': [{ label: 'Elsie, Dictionary of Albanian Religion & Mythology (Vitore)', url: 'https://archive.org/details/dictionaryofalba0000elsi' }],
  'drangue': [{ label: 'Elsie, Dictionary of Albanian Religion & Mythology', url: 'https://archive.org/details/dictionaryofalba0000elsi' }],
  'kulshedra': [{ label: 'Doja, \'Mythology and Destiny\' (Anthropos 2005)', url: 'https://www.jstor.org/stable/40466542' }, { label: 'Elsie, Dictionary of Albanian Religion & Mythology', url: 'https://archive.org/details/dictionaryofalba0000elsi' }],
  ...
  'stihi': [{ label: 'Stihi (Wikipedia)', url: 'https://en.wikipedia.org/wiki/Stihi' }, { label: 'Elsie, Dictionary of Albanian Religion & Mythology', url: 'https://archive.org/details/dictionaryofalba0000elsi' }],
  'shtriga': [{ label: 'Durham, High Albania (1909) — Project Gutenberg', url: 'https://www.gutenberg.org/ebooks/45072' }],
  'karkanxholl': [{ label: 'Karkanxholl (Wikipedia)', url: 'https://en.wikipedia.org/wiki/Karkanxholl' }],
  ...
  'xhindi': [{ label: 'Elsie, Dictionary of Albanian Religion & Mythology', url: 'https://archive.org/details/dictionaryofalba0000elsi' }],
  'katallan': [{ label: 'List of Albanian mythological figures (Wikipedia)', url: 'https://en.wikipedia.org/wiki/List_of_Albanian_mythological_figures' }, { label: 'Elsie, Albanian Folktales and Legends', url: 'http://www.albanianliterature.net/folktales/index.html' }],
  'wolf': [{ label: 'Albanian paganism — wolf totem (Wikipedia)', url: 'https://en.wikipedia.org/wiki/Albanian_paganism' }, { label: 'Elsie, Dictionary of Albanian Religion & Mythology', url: 'https://archive.org/details/dictionaryofalba0000elsi' }],
  ...
  'baloz': [{ label: 'Elsie, Songs of the Frontier Warriors (oral verse)', url: 'http://www.albanianliterature.net/oralverse/verse_01.html' }],
  'lugat': [{ label: 'Elsie, Dictionary of Albanian Religion & Mythology', url: 'https://archive.org/details/dictionaryofalba0000elsi' }],
  'creation-wolf': [{ label: 'von Hahn 105 \'Erschaffung des Wolfes\' — full text (Zeno.org)', url: 'http://www.zeno.org/M%C3%A4rchen/M/Albanien/Johann+Georg+von+Hahn:+Griechische+und+Albanesische+M%C3%A4rchen/105.+Erschaffung+des+Wolfes' }],
  'scurfhead': [{ label: '\'The Scurfhead\' — full text (Elsie tale 2)', url: 'http://www.albanianliterature.net/folktales/tale_02.html' }, { label: 'ATU 301 tale-type', url: 'https://en.wikipedia.org/wiki/The_Three_Stolen_Princesses' }],
  ...
  'maiden-promised-sun': [{ label: '\'The Maiden who was Promised to the Sun\' — full text (Elsie tale 22)', url: 'http://www.albanianliterature.net/folktales/tale_22.html' }],
  ...
  'half-rooster': [{ label: '\'Half Rooster\' — full text (Elsie tale 15)', url: 'http://www.albanianliterature.net/folktales/tale_15.html' }, { label: 'ATU 715 \'Half-Chick\' type', url: 'https://en.wikipedia.org/wiki/Half-Chick' }],
  ...
  'kuma-lisa': [{ label: 'von Hahn 89 (the planted-butter tale, Zeno.org)', url: 'http://www.zeno.org/M%C3%A4rchen/M/Albanien/Johann+Georg+von+Hahn:+Griechische+und+Albanesische+M%C3%A4rchen' }, { label: 'ATU 15 \'The Theft of Butter by Playing Godfather\'', url: 'https://en.wikipedia.org/wiki/The_Fox_and_the_Wolf' }],
  'cuckoo': [{ label: 'von Hahn 104 \'Entstehung des Kuckucks\' — full text (Zeno.org)', url: 'http://www.zeno.org/M%C3%A4rchen/M/Albanien/Johann+Georg+von+Hahn:+Griechische+und+Albanesische+M%C3%A4rchen/104.+Entstehung+des+Kuckucks' }],
  'bee-spider-cicada': [{ label: 'Albanian folk beliefs — bee reverence (Wikipedia)', url: 'https://en.wikipedia.org/wiki/Albanian_folk_beliefs' }],
  ...
  'mujo-strength': [{ label: 'The Marriage of Mujo (Elsie/Mathie-Heck, oralverse 1)', url: 'http://www.albanianliterature.net/oralverse/verse_09_01.html' }],
  ...
  'mujo-courser': [{ label: 'Mujo\'s Courser (Elsie/Mathie-Heck, oralverse 8)', url: 'http://www.albanianliterature.net/oralverse/verse_09_08.html' }],
  'halil-marriage': [{ label: 'The Marriage of Halili (Elsie/Mathie-Heck, oralverse 5)', url: 'http://www.albanianliterature.net/oralverse/verse_09_05.html' }],
  'zuku-bajraktar': [{ label: 'Zuku Bajraktar (Elsie/Mathie-Heck, oralverse 10)', url: 'http://www.albanianliterature.net/oralverse/verse_09_10.html' }, { label: 'Zuku Bajraktar — Albanian text (Visaret e Kombit PDF)', url: 'http://www.albanianliterature.net/oralverse/verse_09_AL/verse_09_AL_10.pdf' }],
  'mujo-avenges-halil': [{ label: 'Songs of the Frontier Warriors (Elsie/Mathie-Heck)', url: 'http://www.albanianliterature.net/oralverse/verse_09.html' }],
  'death-of-omer': [{ label: 'The Death of Omer (Elsie/Mathie-Heck, oralverse 19)', url: 'http://www.albanianliterature.net/oralverse/verse_09_19.html' }, { label: 'Ajkuna\'s Lament (Elsie/Mathie-Heck, oralverse 20)', url: 'http://www.albanianliterature.net/oralverse/verse_09_20.html' }],
  'aga-ymer': [{ label: 'Little Constantine / returning-husband type (Wikipedia)', url: 'https://en.wikipedia.org/wiki/Little_Constantine' }],
  'arnaut-osmani': [{ label: 'Arnaut Osmani (Elsie/Mathie-Heck, oralverse 13)', url: 'http://www.albanianliterature.net/oralverse/verse_09_13.html' }],
  'muji-e-behuri': [{ label: 'Mujo and Behuri (Elsie/Mathie-Heck, oralverse 7)', url: 'http://www.albanianliterature.net/oralverse/verse_09_07.html' }, { label: 'Mujo and Behuri — Albanian text (Visaret e Kombit PDF)', url: 'http://www.albanianliterature.net/oralverse/verse_09_AL/verse_09_AL_07.pdf' }],
  'halil-garria': [{ label: 'Constantin and Doruntinë — returning-dead type (Wikipedia)', url: 'https://en.wikipedia.org/wiki/Constantin_and_Doruntin%C3%AB' }],
  ...
  'constantine-doruntine': [{ label: 'The Ballad of Constantine and Dhoqina (Elsie/Mathie-Heck, oralverse)', url: 'http://www.albanianliterature.net/oralverse/verse_04.html' }],
  'gjergj-elez-alia': [{ label: 'Gjergj Elez Alia (Elsie/Mathie-Heck, oralverse 6)', url: 'http://www.albanianliterature.net/oralverse/verse_09_06.html' }, { label: 'Gjergj Elez Alia — Albanian text (Visaret e Kombit PDF)', url: 'http://www.albanianliterature.net/oralverse/verse_09_AL/verse_09_AL_06.pdf' }],
  'sari-salltek': [{ label: 'Sari Salltëk (Elsie, legend 02)', url: 'http://www.albanianliterature.net/legends/legend_02.html' }, { label: 'Elsie, The Albanian Bektashi: History & Culture of a Dervish Order', url: 'https://catalog.libraries.psu.edu/catalog/27978534' }],
  'tomor-shpirag': [{ label: 'E Bukura e Dheut — the Beauty the giants fought over (Wikipedia)', url: 'https://en.wikipedia.org/wiki/E_Bukura_e_Dheut' }],
  'syri-kalter': [{ label: 'Blue Eye (spring) (Wikipedia)', url: 'https://en.wikipedia.org/wiki/Blue_Eye_(spring)' }],
  'sons-of-eagle': [{ label: 'Albanian legends index (Elsie)', url: 'http://www.albanianliterature.net/legends/' }],
  'gjakova-cavern': [{ label: 'Durham, High Albania (1909) — full text (Internet Archive)', url: 'https://archive.org/details/highalbania00durhuoft' }],
  ...
  'ura-e-artes': [{ label: 'Dundes (ed.), The Walled-Up Wife: A Casebook', url: 'https://www.google.com/books/edition/The_Walled_Up_Wife/nq0aVj2Qff8C' }],
  ...
  'tomorri-pilgrimage': [{ label: 'Elsie, The Albanian Bektashi — Abbas Ali cult on Tomorr', url: 'https://catalog.libraries.psu.edu/catalog/27978534' }],
  'besa': [{ label: 'The Code of Lekë Dukagjinit (Gjeçovi/Fox) — archive.org', url: 'https://archive.org/details/kanuni-i-leke-dukagjinit' }, { label: 'Durham, High Albania (1909) full text', url: 'https://digital.library.upenn.edu/women/durham/albania/albania.html' }],
  'hospitality': [{ label: 'The Code of Lekë Dukagjinit (Fox) — the guest, archive.org', url: 'https://archive.org/details/kanuni-i-leke-dukagjinit' }, { label: 'Durham, High Albania (1909) full text', url: 'https://digital.library.upenn.edu/women/durham/albania/albania.html' }],
  'kanun-blood-feud': [{ label: 'Hasluck, The Unwritten Law in Albania (1954)', url: 'https://archive.org/details/unwrittenlawinal0000marg' }, { label: 'The Code of Lekë Dukagjinit (Fox) — Book on blood', url: 'https://archive.org/details/kanuni-i-leke-dukagjinit' }],
  'evil-eye': [{ label: 'Albanian folk beliefs (Wikipedia)', url: 'https://en.wikipedia.org/wiki/Albanian_folk_beliefs' }],
  ...
  'dita-e-veres': [{ label: 'UNESCO ICH — Cultural practices associated to the 1st of March', url: 'https://ich.unesco.org/en/RL/cultural-practices-associated-to-the-1st-of-march-01287' }],
  ...
  'oda-e-burrave': [{ label: 'Durham, High Albania (1909) — the oda/kulla', url: 'https://digital.library.upenn.edu/women/durham/albania/albania.html' }],
  ...
  'dita-e-shen-gjergjit': [{ label: 'Đurđevdan / St George\'s Day Balkan customs (Wikipedia)', url: 'https://en.wikipedia.org/wiki/%C4%90ur%C4%91evdan' }],
  'kurbani': [{ label: 'Eid al-Adha / Kurban (Wikipedia)', url: 'https://en.wikipedia.org/wiki/Eid_al-Adha' }],
  'burrnesha': [{ label: 'Durham, High Albania (1909) — \'Albanian virgins\'', url: 'https://digital.library.upenn.edu/women/durham/albania/albania.html' }],
  'stani': [{ label: 'Durham, High Albania (1909) — highland pastoral life', url: 'https://digital.library.upenn.edu/women/durham/albania/albania.html' }],
  ...
  'vellameri': [{ label: 'Hasluck, The Unwritten Law in Albania (1954) — sworn kinship', url: 'https://archive.org/details/unwrittenlawinal0000marg' }],
  ...
  'illyrian-kingdom-teuta': [{ label: 'Polybius, Histories Bk. II (Teuta & the Illyrian War, PD)', url: 'https://penelope.uchicago.edu/Thayer/E/Roman/Texts/Polybius/2*.html' }, { label: 'Britannica: Teuta', url: 'https://www.britannica.com/biography/Teuta' }],
  'apollonia-butrint': [{ label: 'UNESCO World Heritage: Butrint (site 570)', url: 'https://whc.unesco.org/en/list/570/' }],
  'roman-conquest-illyria': [{ label: 'Livy, History of Rome Bk. 44 (defeat of Gentius, PD)', url: 'https://www.perseus.tufts.edu/hopper/text?doc=Perseus:text:1999.02.0144' }, { label: 'Britannica: Gentius', url: 'https://www.britannica.com/biography/Gentius' }],
  'via-egnatia': [{ label: 'Britannica: Via Egnatia', url: 'https://www.britannica.com/topic/Via-Egnatia' }],
  ...
  'league-of-lezhe': [{ label: 'Britannica: Skanderbeg', url: 'https://www.britannica.com/biography/Skanderbeg' }],
  'sieges-of-kruje': [{ label: 'Britannica: Skanderbeg (sieges of Krujë)', url: 'https://www.britannica.com/biography/Skanderbeg' }],
  'death-of-skanderbeg': [{ label: 'Noli, George Castrioti Scanderbeg (death at Lezhë, PD)', url: 'https://archive.org/details/georgecastriotis00noli' }, { label: 'Britannica: Skanderbeg', url: 'https://www.britannica.com/biography/Skanderbeg' }],
  'arberesh-exodus': [{ label: 'Britannica: Albanian language (Arbëreshë)', url: 'https://www.britannica.com/topic/Albanian-language' }],
  'ottoman-order': [{ label: 'Britannica: Timar', url: 'https://www.britannica.com/topic/timar' }],
  ...
  'conversion-and-bektashi': [{ label: 'Britannica: Bektashi', url: 'https://www.britannica.com/topic/Bektashi' }],
  'voskopoje-enlightenment': [{ label: 'Britannica: Aromani (Vlachs)', url: 'https://www.britannica.com/topic/Aromani' }],
  'ali-pasha-ioannina': [{ label: 'Leake, Travels in Northern Greece (PD)', url: 'https://archive.org/details/travelsinnorther01leak' }],
  'rilindja-awakening': [{ label: 'Britannica: Albanian language (Congress of Manastir)', url: 'https://www.britannica.com/topic/Albanian-language' }],
  'league-of-prizren': [{ label: 'Skendi, The Albanian National Awakening', url: 'https://archive.org/details/albaniannational0000sken' }, { label: 'Britannica: League of Prizren', url: 'https://www.britannica.com/event/League-of-Prizren' }],
  ...
  'independence-1912': [{ label: 'Skendi, The Albanian National Awakening (1912 Vlora)', url: 'https://archive.org/details/albaniannational0000sken' }, { label: 'Britannica: Albania — Independence', url: 'https://www.britannica.com/place/Albania/Independence' }],
  'shote-azem-galica': [{ label: 'Elsie, Biographical Dictionary of Albanian History (Galica)', url: 'https://archive.org/details/biographicaldict0000elsi' }],
  'gjakmarrja': [{ label: 'Durham, High Albania — \'The Land and the Law\' (PD)', url: 'https://archive.org/details/highalbania0000durh' }],
}
