...
export const WORLD_LANDMARKS = [
  ...
  { id: 'majaEagle', glyph: 'gEagle', label: "Baba Tomor's eagle & shrine", x: 300, y: -820 },
  { id: 'shurdhi1', glyph: 'gShurdhi', label: 'Shurdhi', x: 110, y: -560 },
  { id: 'verbti1', glyph: 'gVerbti', label: 'i Verbti', x: 110, y: -560 },
  ...
  { id: 'tomorProva', glyph: 'gShurdhi', label: "Tomorr's thunder trial", x: 300, y: -820 },
  ...
  { id: 'henaPaqe', glyph: 'gHena', label: 'Hëna (the Moon)', x: -120, y: -1230 },
  ...
  { id: 'udhaShenja', glyph: 'gWaySign', label: 'the surface way-signs', x: 15, y: 1020 },
  ...
  { id: 'bijaHene1', glyph: 'gBijaHene', label: 'E Bija e Hënës e Diellit', x: 620, y: 2340 },
  // the river & the Zana (down the centre, below the village)
  { id: 'lumi', glyph: 'gBolla', label: 'the Bolla', x: 200, y: 820 },
  { id: 'zana1', glyph: 'gZana', label: 'the Zana', x: 200, y: 820 },
  { id: 'zanaProva', glyph: 'gCradleRock', label: "the Zana's trial", x: 410, y: 1040 },
  { id: 'zanaQumesht', glyph: 'gZanaGift', label: "the Zana's gifts", x: 410, y: 1040 },
  ...
  { id: 'karkanxholl1', glyph: 'gRevenant', label: 'the iron-clad revenant', x: -560, y: 720 },
