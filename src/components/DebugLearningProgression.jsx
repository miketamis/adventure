      ...
      <div className="dbg-learning-layout">
        ...
        <div className="dbg-learning-lanes">
          ...
          <section className="dbg-learning-rules dbg-learning-foot" aria-labelledby="dbg-learning-scheduling-title">
            ...
            <ul>
              <li>The scheduler compares the last {TRAIN_QUESTION_MIX_POLICY.activityBalance.historyWindow} activity formats and chooses one of the least-shown formats that is genuinely due now. It never repeats the immediately previous format; if no different legal format exists, Train reports that you are caught up.</li>
