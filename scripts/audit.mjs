...
const ALLOW = new Set('buke kripe gur fuqi bekim shqiponje ujk ora zjarr fshat udhekryq mal lume jutbina maja pyll det breshka gjarper toke bese dem flok vatra qilim bari oda kulle rruge shtepi pus lubia kemishe valle pallat kopsht oborr vella kufi shpelle pishtar treg qytet lek lahute ure shesh feste'.split(' '))
