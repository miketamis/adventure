...
export const RULE_GATE_MANIFEST = Object.freeze([
  ...
  ...section('Player causality and knowledge provenance', [
    executable('causality.exact-action-consequence', 40, 'e214c0d7753b9ca5', 'narrative-systems', ['playercausality', 'projectededge', 'consequencecoherence']),
    executable('causality.affordance-continuity', 41, '1dbb529797a3a02d', 'narrative-systems', ['actionpresupposition', 'playercausality']),
    executable('causality.predecessor-specific-arrival', 42, '769d2cee4f771afd', 'narrative-systems', ['playercausality', 'projectededge']),
    executable('causality.choice-outcome-after-action', 43, '605aae7cf6682fb1', 'narrative-systems', ['playeractionprovenance']),
    executable('causality.earned-payment-before-agency', 44, '9742f5f68d013755', 'narrative-systems', ['economy', 'narrativeflow', 'projectededge']),
  ...
  ...section('Immersion and debug boundaries', [
    ...
    executable('immersion.movement-and-appointment-continuity', 132, 'e4f38e7cf9804284', 'narrative-systems', ['speechmovement', 'state', 'playercausality', 'projectededge']),
    ...
    executable('immersion.no-mandatory-continue-chains', 135, 'c0cc940443d247ac', 'narrative-systems', ['narrativeflow', 'projectededge']),
  ...
  ...section('Conversation agency and character presence', [
    ...
    executable('conversation.in-place-voluntary-topic-hub', 142, '29cda904cf013719', 'narrative-systems', ['conversationhub', 'projectededge']),
    executable('conversation.detect-speak-monologue-exit', 143, '492a4412ae4fe859', 'narrative-systems', ['conversationhub']),
    executable('conversation.condition-aware-agency', 144, 'a0ff036d59fe7a2a', 'narrative-systems', ['narrativeflow', 'projectededge']),
    ...
    executable('conversation.exact-player-action-provenance', 148, '122c74f789830c5b', 'narrative-systems', ['playeractionprovenance', 'projectededge']),
